...
description: X-Trend model architecture with cross-attention mechanisms for trading. Covers LSTM encoders, cross-attention, self-attention, sequence representations, entity embeddings, Variable Selection Networks (VSN), encoder-decoder patterns, attention mechanisms, Deep Momentum Networks, interpretable predictions. Use when implementing X-Trend model or attention-based trading strategies.
---
...
**Zero-Shot (2018-2023):**
- Baseline: Sharpe = -0.11
- X-Trend-G: Sharpe = 0.47
...
- X-Trend (Wood, Kessler, Roberts, Zohren 2024)
